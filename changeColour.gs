...
function findColour(outline) {
  ...
  var pink = {name: "pink", lightest: "#fadfeb", lighter: "#d5a6bd", light: "#c27ba0", plain: "#a64d79", deep: "#741b47", dark: "#4c1130", banding: SpreadsheetApp.BandingTheme.PINK};
  var purple = {name: "purple", lightest: "#e9e1fa", lighter: "#b4a7d6", light: "#8e7cc3", plain: "#674ea7", deep: "#351c75", dark: "#20124d", banding: SpreadsheetApp.BandingTheme.INDIGO};
  var blue = {name: "blue", lightest: "#d5e8fa", lighter: "#9fc5e8", light: "#6fa8dc", plain: "#3d85c6", deep: "#0b5394", dark: "#073763", banding: SpreadsheetApp.BandingTheme.BLUE};
  var teal = {name: "teal", lightest: "#e0f7fa", lighter: "#a2c4c9", light: "#76a5af", plain: "#45818e", deep: "#134f5c", dark: "#0c343d", banding: SpreadsheetApp.BandingTheme.CYAN};
  var green = {name: "green", lightest: "#d4fac3", lighter: "#b6d7a8", light: "#93c47d", plain: "#6aa84f", deep: "#38761d", dark: "#274e13", banding: SpreadsheetApp.BandingTheme.GREEN};
  var yellow = {name: "yellow", lightest: "#fff1ca", lighter: "#ffe599", light: "#ffd966", plain: "#f1c232", deep: "#bf9000", dark: "#7f6000", banding: SpreadsheetApp.BandingTheme.YELLOW};
  var orange = {name: "orange", lightest: "#ffe2c4", lighter: "#f9cb9c", light: "#f6b26b", plain: "#e69138", deep: "#b45f06", dark: "#783f04", banding: SpreadsheetApp.BandingTheme.ORANGE};
  var red = {name: "red", lightest: "#fddcdc", lighter: "#dd7e6b", light: "#cc4125", plain: "#a61c00", deep: "#85200c", dark: "#5b0f00", banding: SpreadsheetApp.BandingTheme.PINK};
  var grey = {name: "grey", lightest: "#f8f8f8", lighter: "#cccccc", light: "#b7b7b7", plain: "#999999", deep: "#666666", dark: "#434343", banding: SpreadsheetApp.BandingTheme.GREY};
